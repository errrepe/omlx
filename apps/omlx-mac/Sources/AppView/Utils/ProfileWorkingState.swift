...
enum ProfileSettingsKey {
    ...
    static let qwen35AnePrefillSwigluInAne = "qwen35_ane_prefill_swiglu_in_ane"
    static let qwen35AnePrefillMoeSharedExpert = "qwen35_ane_prefill_moe_shared_expert"
    static let qwen35AnePrefillOproj = "qwen35_ane_prefill_oproj"
    static let qwen35AnePrefillOprojFraction = "qwen35_ane_prefill_oproj_fraction"
    static let qwen35AnePrefillOprojMaxLayers = "qwen35_ane_prefill_oproj_max_layers"
